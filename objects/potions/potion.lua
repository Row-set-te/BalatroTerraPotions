...
assert(SMODS.load_file('./objects/potions/mushroom.lua'))()
...
assert(SMODS.load_file('./objects/potions/endurance.lua'))()
assert(SMODS.load_file('./objects/potions/summoning.lua'))()